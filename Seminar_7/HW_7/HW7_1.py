...
"""
# **Примечание.**
# - Подумайте об эффективнос
# и алгоритма. Какие структуры данных будут более эффективны по скорости.
...
def rythmCheck (lyrics):
    sounndcheck = ("а, о, у, ы, и, е, ю")
    lyrics = lyrics.split()
    newlist =[]
    for word in lyrics :
        result = 0
        for sound in word:
            if sound in sounndcheck:
                result += 1
        newlist.append(result)
    if len(newlist) == newlist.count(newlist[0]):
        return True
    else:
        return False

print(rythmCheck("пара-ра-рам рам-пам-папам па-ра-па-дам")) 
print(rythmCheck("пара-ра-рам рам-пум-пупам па-ре-по-дам")) 
print(rythmCheck("пара-ра-рам рам-пуум-пупам па-ре-по-дам"))
print(rythmCheck("Трам-пара-папам-парам-па-пам-пам-па Пум-пурум-пу-пурум-трам-пам-па"))
print(rythmCheck("Пам-парам-пурум Пум-пурум-карам"))